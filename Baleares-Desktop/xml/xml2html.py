...
class GeneradorRutasHTML:
    ...
    def prologo(self):
        ...
        self.escribir('        <nav>\n')
        self.escribir('            <a href="index.html" >Inicio</a>\n')
        self.escribir('            <a href="gastronomia.html" >Gastronomía</a>\n')
        self.escribir('            <a href="rutas.html" class="active" >Rutas</a>\n')
        self.escribir('            <a href="meteorologia.html"  >Meteorología</a>\n')
        self.escribir('            <a href="juego.html" >Juego</a>\n')
        self.escribir('            <a href="php/reservas.php" >Reservas</a>\n')
        self.escribir('            <a href="ayuda.html" >Ayuda</a>\n')
        self.escribir('        </nav>\n')
        self.escribir('    </header>\n')
